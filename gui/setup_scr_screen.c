...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(ui->screen_cont_1, &_e_1280x720, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 88, 70);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 88, 70);
