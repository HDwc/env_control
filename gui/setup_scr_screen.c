...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0xf00000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_cont_2, 65, 22);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_2, lv_color_hex(0x52ff00), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_1_label, "111");
    lv_label_set_long_mode(ui->screen_btn_1_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_1_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_1, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_1, 87, 70);
    ...
    lv_obj_set_pos(ui->screen_cont_3, 62, 450);
    lv_obj_set_size(ui->screen_cont_3, 300, 200);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_3, lv_color_hex(0x00a8ff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_2_label, "222");
    ...
    lv_obj_set_pos(ui->screen_btn_2, 87, 70);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_2, lv_color_hex(0xff00cd), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_cont_4, 753, 162);
    lv_obj_set_size(ui->screen_cont_4, 300, 200);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_4, lv_color_hex(0xd7ff00), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_3_label, "333");
    ...
    lv_obj_set_pos(ui->screen_btn_3, 88, 70);
